...
//    private String mobile_brand;
    NSDictionary *headerDic = @{@"os_type":@2,@"version":kApplication.appVersion,@"clientId":@"1",@"versioncode":@1};
    NSString *contentStr = [headerDic jsonStringEncoded];
